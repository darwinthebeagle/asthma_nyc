...
<iframe width="560" height="315" src="https://www.youtube.com/embed/watch?v=vtIguH0EzTo&fbclid=IwAR0LBnSY1sajqOpsmqIMxJ4KgyeoxmEu0T-9WeJ-qgt6_UMjA_MQlnklfQI" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
...
[here](https://github.com/darwinthebeagle/asthma_nyc/blob/master/Linear_regression.Rmd). 

For both child and adult rates of ED visits, levels of neighborhood PM 2.5 air pollution do not appear to have a statistically significant effect after adjusting for 
...
**Final Conclusions:** 
There are significant differences in pollution exposures between boroughs and within neighborhoods belonging to the same borough. Based on the levels of asthma-related emergency visits, hospitalization, and deaths, there is a similar observation of health gaps. More research and analyses should be conducted to address the asthma disparities across neighborhoods in New York City.
